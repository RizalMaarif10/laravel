        ...
        <div class="col-md-5">
          <div class="bg-info p-3 rounded-3">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-sm mb-2 @error('gambar') is-invalid @enderror" id="gambar" name="gambar" 
            ...
            <div class="text-center">
              ...
              <div class="d-grid gap-2 col-8 mx-auto">
                ...
                <a href="/index/admin" type="button" class="btn btn-warning">Kembali</a>
