...
<body>
    ...
    <form action="{{ route('tampilan.merch.update', ['id' => $merchant->id]) }}" method="POST" >
    @csrf
                    ...
                    <div class="bg-info p-3 rounded-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="deskripsi" name="deskripsi"
                                ...
                                rows="3">{{ $merchant->Deskripsi }}</textarea>
                        </div>
